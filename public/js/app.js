// =========================================================================
// SAFE WRAPPER: prevents any error from breaking the whole script
// =========================================================================
(function() {
    try {
        // =========================================================================
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // =========================================================================
            // ---- GLOBAL switchTab FUNCTION (defined early) ----
            ...
            window.setFocusMarket = function(sym) {
                ...
                } catch(e) { console.error('setFocusMarket error:', e); }
            };
            ...
            function renderDigitsTab() {
                try {
                    ...
                    if (matrix.length === 0) {
                        // Empty state
                        const emptyRow = '<td><strong>—</strong></td><td colspan="10">—</td>';
